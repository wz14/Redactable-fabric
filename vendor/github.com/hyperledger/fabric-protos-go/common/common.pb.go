...
type Payload struct {
	...
	// ChamHash define here , valueOfHash equals Hash(Payload(header,data,nil))
	Chamhash             []byte   `protobuf:"bytes,3,opt,name=chamhash,proto3" json:"chamhash,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Payload) GetChamhash() []byte {
	if m != nil {
		return m.Chamhash
	}
	return nil
...
var fileDescriptor_8f954d82c0b891f6 = []byte{
	...
	,
}
